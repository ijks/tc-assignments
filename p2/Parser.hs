...
action_6 (13) = happyShift action_20
...
action_24 (15) = happyShift action_34
...
action_34 (31) = happyShift action_31
action_34 (32) = happyShift action_32
action_34 (10) = happyGoto action_36
action_34 (11) = happyGoto action_26
...
happyNewToken action sts stk (tk:tks) =
	...
	AltSep -> cont 15;
	Keyword "go" -> cont 16;
	Keyword "take" -> cont 17;
	Keyword "mark" -> cont 18;
	Keyword "nothing" -> cont 19;
	Keyword "turn" -> cont 20;
	Keyword "case" -> cont 21;
	Keyword "of" -> cont 22;
	Keyword "end" -> cont 23;
	Direction "left" -> cont 24;
	Direction "right" -> cont 25;
	Direction "front" -> cont 26;
	Pattern "Empty" -> cont 27;
	Pattern "Lambda" -> cont 28;
	Pattern "Debris" -> cont 29;
	Pattern "Asteroid" -> cont 30;
	Pattern "Boundary" -> cont 31;
	Pattern "_" -> cont 32;
...
{-# LINE 9 "<command-line>" #-}
{-# LINE 1 "C:\\Users\\randy\\AppData\\Local\\Temp\\ghc9164_0\\ghc_2.h" #-}
